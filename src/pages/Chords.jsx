...
const Chords = ({ imageLink, chordKey, onClose, isPremium }) => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="w-screen h-screen  md:flex md:justify-center absolute inset-0 z-20 c-bg overflow-hidden overflow-y-auto px-4 md:pt-12 md:px-24"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: 50 }}
          transition={{ duration: 0.3, ease: "easeInOut" }}
        >
          <div className="lyrics-width ">
            {/* Header */}
            ...
            <div className="py-4 pb-20">
              ...
              <div className="border c-border rounded-md p-4 space-y-2">
                ...
                <div className="flex mt-4">
                  ...
                  <div className="flex flex-col gap-2 c-soft-shadow w-full">
                    ...
                    {activeVariant && groupedVariants[activeVariant] && (
                      <AnimatePresence mode="wait">
                        <motion.div
                          ...
                          className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 p-4 py-2"
                        >
